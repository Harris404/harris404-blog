  ...
  return (
    <div className="layout">
      ...
      <header className="mobile-header">
        ...
        <Link to="/" className="mobile-header__logo">Harris's Blog</Link>
        <ThemeToggle />
      </header>
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar--open' : ''}`}>
        <div className="sidebar__inner">
          <div className="sidebar__profile">
            ...
            <h2 className="sidebar__name">Harris</h2>
            <p className="sidebar__bio">
              Exploring LLMs, paper analysis, and code. Learning by writing.
            </p>
      ...
      <main className="main-content">
        ...
        <footer className="footer">
          <p>© 2026 Harris · Built with passion for AI</p>
        </footer>
      </main>
    </div>
  );
